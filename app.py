import sys
# Ensure system/site-packages are preferred over the project root so installed
# packages (like the real `six`) are imported instead of any local shim named
# `six` that might accidentally shadow them.
if '' in sys.path:
    sys.path.remove('')
    sys.path.append('')
